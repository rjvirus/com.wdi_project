...
public class MarketValueFuserLongestString extends AttributeValueFuser<String, Player, Attribute> {

    public MarketValueFuserLongestString() {
        super(new LongestString<>());
    }

    @Override
    public boolean hasValue(Player record, Correspondence<Attribute, Matchable> correspondence) {
        return record.hasValue(Player.MARKETVALUE19);
    }

    @Override
    public String getValue(Player record, Correspondence<Attribute, Matchable> correspondence) {
        return Integer.toString(record.getMarket_value_19());
    }
