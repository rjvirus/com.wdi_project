...
public class OverallFuserLongestString extends AttributeValueFuser<String, Player, Attribute> {

    public OverallFuserLongestString() {
        super(new LongestString<>());
    }

    @Override
    public boolean hasValue(Player record, Correspondence<Attribute, Matchable> correspondence) {
        return record.hasValue(Player.OVERALL);
    }

    @Override
    public String getValue(Player record, Correspondence<Attribute, Matchable> correspondence) {
        return Integer.toString(record.getOverall());
    }
